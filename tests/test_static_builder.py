...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                'headers':['foo', 'bar'], 
                'data':[('header_1', 'header_2'), ('val_1', 'val_2'), ('val_3', 'val_4')]
            }
        ),
        (
            "filtered.csv",False,None,
            {
                'headers':['foo', 'bar'], 
                'data':[('val_2', None)]
            }
...
def test_static_tables(tmp_path, mock_db_config,filtered,ignore_header,mapping,expected):
