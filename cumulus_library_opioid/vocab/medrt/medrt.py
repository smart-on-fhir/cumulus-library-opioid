...
def drop_tables():
    _tables = [f"MRREL_medrt_cui{tier}" for tier in range(1, 10)]
...
def medrt(where: str):
    ...
    # TODO: notice, this is the soft "max" depth of MEDRT, the recursion shoudl STOP when there are new matches.
